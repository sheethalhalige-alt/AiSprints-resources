...
export default function EditQuestionPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const fetchQuestion = useCallback(async () => {
    try {
      ...
      const data = await response.json() as { success?: boolean; question?: Question; message?: string };
      ...
      <nav className="border-b border-slate-700 bg-slate-800/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold text-slate-100">Edit Question</h1>
          </div>
        </div>
      </nav>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Card className="border-slate-700 bg-slate-800/50 mb-6">
            <CardHeader>
              ...
              <CardDescription className="text-slate-400">
                Edit the question text (10-1000 characters)
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Textarea
          ...
          <Card className="border-slate-700 bg-slate-800/50 mb-6">
            <CardHeader>
              ...
              <CardDescription className="text-slate-400">
                Edit options and select the correct answer
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-slate-700 bg-slate-800/50 mb-6">
            <CardHeader>
              ...
              <CardDescription className="text-slate-400">
                Update difficulty, category, and points
              </CardDescription>
            </CardHeader>
            <CardContent>
